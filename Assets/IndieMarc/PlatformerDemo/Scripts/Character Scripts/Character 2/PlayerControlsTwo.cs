...
namespace IndieMarc.Platformer
{
    ...
    public class PlayerControlsTwo : MonoBehaviour
    {
        ...
        public KeyCode jump_key = KeyCode.Space; // Commonly used jump key
        public KeyCode action_key = KeyCode.E;   // Set to E or another preferred action key
        ...
        {
            foreach (PlayerControlsTwo control in GetAll())
            {
